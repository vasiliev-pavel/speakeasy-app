...
openai.api_key = "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"
# Настройка логирования
logging.basicConfig(format='%(asctime)s - %(name)s - %(levelname)s - %(message)s',
                    level=logging.INFO)
logger = logging.getLogger(__name__)
# Инициализация словаря, который будет хранить историю диалога с каждым пользователем
user_history = {}
# Инициализация бота и диспетчера
bot = aiogram.Bot(token="6209630588:AAHydfp8VM6X-S76Akxar1qdNETWVxfy5Ac")
